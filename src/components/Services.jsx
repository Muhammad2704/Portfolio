...
const servicesData = [
  {
    ...
    description: 'I design and deploy end-to-end interactive reporting systems that turn complex, raw data into visual executive dashboards, tracking key business metrics and strategic performance.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'I write efficient queries to extract, filter, aggregate, and structure relational data from MySQL databases for comprehensive analysis and reporting.',
    capabilities: [
      'Relational Database Querying (MySQL)',
  ...
  },
  {
    ...
    description: 'I utilize Python libraries to manipulate datasets, clean irregular inputs, conduct statistical analysis, and render static/interactive data charts.',
    capabilities: [
  ...
  },
  {
    ...
    description: 'I build analytical spreadsheets, automated formulas, and rapid summary reports using high-level Excel features for quick analytical turnarounds.',
    capabilities: [
      'PivotTables & PivotCharts',
      'Advanced Formulas & Lookup Functions',
      'Data Cleaning & Standardization',
      'Quick Executive Summary Reports'
    ]
  },
  {
    id: '05',
    title: 'DATA MODELING & ETL PIPELINES',
    description: 'I structure raw datasets into optimized analytical schemas—such as Star Schemas—ensuring high report performance, seamless joins, and accurate metrics.',
    capabilities: [
  ...
  {
    id: '06',
    title: 'ANALYTICS TOOLS & WORKFLOWS',
    description: 'I manage data projects, codebase version control, and query development using modern developer tools to maintain efficiency and reliability.',
    capabilities: [
      'Power BI Desktop',
      'MySQL Workbench',
    ...
    <section id="service" className="md:min-h-screen bg-[#050505] text-white pt-12 pb-12 md:pb-24 px-6 md:px-16 flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-end md:items-start justify-end w-full mt-0 z-0 pb-12">
        <div className="flex flex-col md:flex-row items-start justify-end gap-2 md:gap-4 lg:gap-8 pr-2 md:pr-0 text-right">
          <h2 ref={titleRef} className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-black tracking-tighter text-transparent bg-clip-text bg-linear-to-b from-white via-gray-300 to-gray-800 drop-shadow-2xl leading-[1.1] md:leading-[0.9] text-right">
            WHAT WE<br/>CAN DO
          </h2>
        </div>
      </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-start">
              ...
              <div className="flex items-start justify-between w-full lg:w-1/2 gap-2">
                <div className="flex items-start gap-3 md:gap-16 w-full min-w-0">
                  <div className="h-7 flex items-center md:h-10 shrink-0">
                  ...
                  <div className="flex flex-col w-full min-w-0">
                    ...
                    <div 
                      className={`overflow-hidden transition-all duration-500 ease-in-out w-full ${
                        activeIndex === index ? 'max-h-200 opacity-100' : 'max-h-0 opacity-0'
                      }`}
                    >
                ...
                {/* Mobile Arrow Icon */}
                <div className="h-7 flex items-center shrink-0 lg:hidden">
                  <svg 
              ...
              <div className="flex flex-row gap-6 w-full lg:w-1/2 justify-between lg:justify-end relative items-start">
                ...
                >
                   <div className="pt-4 md:pt-6 lg:pt-18 flex flex-col gap-6 w-full pr-0 lg:pr-12">
                     ...
                     {service.buttonText && (
                       <a href="#project" className={`font-bold uppercase tracking-wider text-xs md:text-sm px-6 py-3 border transition-colors duration-300 ease-in-out flex items-center gap-2 mt-4 w-fit ${
                ...
                {/* Desktop Arrow Icon */}
                <div className="hidden lg:flex shrink-0 h-10 items-center">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
